...
class TrafficLight(object):
    ...
    def __init__(self, state=None, period=None):
        # At the beginning if n state nor period is provided, then will randomly select a stete or period
    ...
    def update(self, t):
        # NOTE: what is t? so far based on code blow, it is used for conditioning on whether the state(light) should be changed
...
class Environment(object):
    ...
    def __init__(self, num_dummies=3):
        self.num_dummies = num_dummies  # no. of dummy agents, aka the other cars on the road
        ...
        # Road network: building the road grid
